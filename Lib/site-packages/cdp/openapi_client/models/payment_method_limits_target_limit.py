...
class PaymentMethodLimitsTargetLimit(BaseModel):
    """
    The limit for this payment method being used as a target for transfers.
    """ # noqa: E501
    amount: Optional[StrictStr] = Field(default=None, description="The amount of the limit.")
    currency: Optional[StrictStr] = Field(default=None, description="The currency of the limit.")
